    ...
    <section className="bg-blue-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="flex gap-4 justify-center">
          <a href="#contact" className="bg-white text-blue-950 px-8 py-3 rounded-lg font-bold hover:bg-gray-200">
            Get In Touch
          </a>
          <a href="https://github.com/brunokago" target="_blank" rel="noopener noreferrer" className="bg-white text-blue-950 px-8 py-3 rounded-lg font-bold hover:bg-gray-200">
            View GitHub
          </a>
        </div>
      </div>
